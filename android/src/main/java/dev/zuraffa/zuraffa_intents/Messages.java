...
public class Messages {
  ...
  private static class ZuraffaIntentsApiCodec extends StandardMessageCodec {
    public static final ZuraffaIntentsApiCodec INSTANCE = new ZuraffaIntentsApiCodec();
    private ZuraffaIntentsApiCodec() {}
    @Override
      ...
      } else 
{
  ...
  public interface ZuraffaIntentsApi {
    ...
    /** The codec used by ZuraffaIntentsApi. */
    static MessageCodec<Object> getCodec() {
      return ZuraffaIntentsApiCodec.INSTANCE;
    }

    /** Sets up an instance of `ZuraffaIntentsApi` to handle messages through the `binaryMessenger`. */
    static void setup(BinaryMessenger binaryMessenger, ZuraffaIntentsApi api) {
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.ZuraffaIntentsApi.getInitialSharedMedia", getCodec());
        if (api != null) {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.ZuraffaIntentsApi.recordSentMessage", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.ZuraffaIntentsApi.resetInitialSharedMedia", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
