...
import 'package:zuraffa_intents/tdd/001-intents-port/u4_subject.dart'
    as subject;

void main() {
  group('U4 (FR-004, SharedMedia)', () {
    test(
      'U4 — `SharedMedia` MUST be an immutable entity with the plugin\'s',
      () {
        final result = (() {
          try {
        ...
        expect(
          minimalJson.containsKey('content'),
          isFalse,
