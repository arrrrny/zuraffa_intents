...
import 'package:zuraffa_intents/tdd/001-intents-port/u9_subject.dart'
    as subject;
...
void main() {
  group('U9 (FR-009, ShareIntentService.sharedMediaStream)', () {
    test(
      'U9 — `ShareIntentService` MUST be a thin facade over the port —',
      () async {
