...
import 'package:zuraffa_intents/tdd/002-publishable-plugin/u2_subject.dart'
    as subject;
  ...
  group('U2 (FR-002, wire maps)', () {
    test('U2 — Wire-map fidelity — `sharedAttachmentWireMap` MUST produce', () {
      expect(
        ...
        <Object?, Object?>{
          'path': '/tmp/a.png',
          'type': SharedAttachmentType.image.index,
        },
      );
