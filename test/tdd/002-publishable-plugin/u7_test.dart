...
import 'package:zuraffa_intents/tdd/002-publishable-plugin/u7_subject.dart'
    as subject;

void main() {
  group(
    'U7 (FR-007, MethodChannelShareIntentPort.resetInitialSharedMedia)',
    () {
      test(
        'U7 — `resetInitialSharedMedia` MUST send a null payload on its',
        () async {
