...
import 'package:zuraffa_intents/tdd/002-publishable-plugin/u10_subject.dart'
    as subject;
  ...
  group('U10 (FR-010, native consistency)', () {
    test('U10 — Native port consistency — the ported native trees', () {
      ...
      expect(
        dart['event'],
        isNotEmpty,
        reason: 'the Dart literals anchor the scan',
      );
